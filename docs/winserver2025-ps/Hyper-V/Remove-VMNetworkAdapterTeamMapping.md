...
## 描述
**Remove-VMNetworkAdapterTeamMapping** cmdlet
...
### -ComputerName
指定一个或多个 Hyper-V 主机。可以使用 NetBIOS 名称、IP 地址或完全限定域名进行标识。默认值是本地计算机。可以使用 “localhost” 或点（.）来明确表示本地计算机。
