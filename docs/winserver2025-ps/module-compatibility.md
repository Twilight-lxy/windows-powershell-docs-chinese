...
ms.date: 02/07/2024
title: PowerShell 7 模块在 Windows Server 2025中的兼容性
---
# PowerShell 7 模块在 Windows Server 2025中的兼容性
...
如果您有需要分享的信息，或者对某些特定模块存在疑问，请通过 Windows Feedback Hub 提交反馈。如需了解更多信息，请参阅
...
- 适用于Windows功能
  ...
  请注意：该功能包的名称以 `~~~~0.0.1.0` 结尾；因此，在安装该功能时必须使用其完整的名称。
