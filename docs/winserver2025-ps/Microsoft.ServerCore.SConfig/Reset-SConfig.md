...
ms.date: 02/21/2024
online version: https://learn.microsoft.com/powershell/module/microsoft.servercore.sconfig/reset-sconfig?view=windowsserver2025-ps&wt.mc_id=ps-gethelp
schema: 2.0.0
title: Reset-SConfig
---
...
```
Reset-SConfig [-AllUsers] [-WhatIf] [-Confirm] [<CommonParameters>]
```
